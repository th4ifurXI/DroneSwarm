...
public class Flock : MonoBehaviour
{
    ...
    public DroneCommunication HighBattComms { get; private set; } = new DroneCommunication();
    public DroneCommunication LowBattComms { get; private set; } = new DroneCommunication();
    ...
    public void search()
    {
        ...
        if (DroneU.SearchDrone(HighBattComms))
        {
        ...
        if (!foundInHighBatt)
        {
            DroneU.SearchDrone(LowBattComms);
        }
    }
    ...
    public void SelfDestruct()
    {
        ...
        if (DroneU.SelfDestruct(HighBattComms))
        {
            Destruct = true;
        }
        if (!Destruct)
        {
            DroneU.SelfDestruct(LowBattComms);
        }
    }
