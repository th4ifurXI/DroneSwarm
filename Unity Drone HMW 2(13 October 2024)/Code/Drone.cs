//Drone made for search and rescue
...
public class Drone : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        BatteryLevel = (int)(Random.value * 100);
    ...
    private void Update()
    {
        ...
        GPSLocation += new Vector2(Random.Range(-1.0f, 1.0f), Random.Range(-1.0f, 1.0f)) * Time.deltaTime; //Changes the value of GPS location after each interval
    }
